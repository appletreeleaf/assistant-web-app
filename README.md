...
## 기능
- **문서 도우미**: 업로드한 파일(링크)의 내용을 바탕으로 챗봇과 질의응답합니다. 필요한 경우 실시간으로 검색한 정보를 응답에 활용합니다.
  - **시연영상** | [유튜브 링크](https://youtu.be/uXDYjxx_Ga4)
- **일정 관리**: 챗봇과 대화를 통해 일정을 관리합니다. 장소, 시간, 교통편 등 다양한 정보를 제공합니다.
  - **시연영상** | [유튜브 링크](https://youtu.be/z0348okqjT0)
- **요약**: 뉴스기사, 블로그, 보고서 등 핵심적인 부분을 추린 요약본을 제공합니다.
  - **시연영상** | [유튜브 링크](https://youtu.be/uf5FQ-ABIXI)
- **장소 추천**: 지역(강남역, 경복궁 근처)을 입력하면 회식, 모임, 데이트 장소에 대한 정보를 제공합니다.
